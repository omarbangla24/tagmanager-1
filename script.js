...
<style>
	...
	.motion-banner {
		background: url('https://i.ibb.co/6HBjKzK/T1.jpg');
		display: flex;
...
<div class="motion-banner">
	<div class="motion-area">
		<div class="motion-banner-info">
			<h2>Physical Therapy in Cape Coral, FL</h2>
            <p>If You're Stressed Out About an Injury, Ache, or a Pain, We've Got Your Back!</p>
			<ul>
				<li>
					${check_html}
					<span>Get to the Root Cause of Your Injury So You Don't Have to Deal With it Anymore</span>
				</li>
				<li>
					${check_html}
					<span> Overcome Daily Movement Challenges Without Stiff Joints Holding You Back</span>
				</li>
				<li>
					${check_html}
					<span>Improve Your Posture & Find Out What is Wrong Without Having to See Your Primary Care Doctor First</span>
				</li>
			</ul>
            <a href="https://backinmotionsspt.com/contact-us/">Inquire About an Appointmnet</a>
		</div>
	</div>
</div>
